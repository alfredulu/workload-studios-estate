  ...
  return (
    <section className="mx-auto flex max-w-6xl flex-col gap-16 px-6 pb-20 pt-6">
      <motion.div
        ...
        viewport={{ once: true }}
        className="grid gap-10 rounded-[40px] border border-black/5 bg-white/80 p-8 shadow-glass shadow-slate-200/40 md:grid-cols-[1.1fr,0.9fr]"
      >
        ...
        <div className="relative overflow-hidden rounded-[32px] border border-black/5 bg-deepSlate/30 p-10">
          <div
