...
const journeySteps = [
  {
    label: "Discovery",
    detail: "Curated site visit, valuation, and bespoke marketing brief within 48 hours.",
  },
  {
    label: "Storytelling",
    detail: "Cinematic staging, editorial content, and investor-ready dossiers.",
  },
  {
    label: "Demand",
    detail: "Private showings, pre-qualified buyers, and quiet listings for discretion.",
  },
  {
    label: "Closing",
    detail: "Contract support, concierge closing, and bespoke handover rituals.",
  },
];
...
export default function SellPage() {
  return (
    <section className="mx-auto max-w-6xl space-y-12 px-6 pb-20 pt-16">
      ...
      >
        <p className="text-xs uppercase tracking-[0.4em] text-slate-400">Sell With Us</p>
        <h1 className="mt-2 text-4xl font-display text-deepSlate">Architectural marketing for elite sellers.</h1>
        <p className="mt-4 text-lg text-slate-600">
          We engineer the seller’s journey with tactility, precision, and premium audiences to achieve the fastest, most discreet closing.
        </p>
      ...
      <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr]">
        ...
        >
          <p className="text-xs uppercase tracking-[0.4em] text-slate-400">Seller’s Journey</p>
          <div className="space-y-4">
            {journeySteps.map((step, index) => (
              <div key={step.label} className="flex gap-4">
                ...
                <div>
                  <p className="text-sm font-display text-deepSlate">{step.label}</p>
          ...
          <div className="rounded-2xl border border-black/5 bg-slate-50/60 p-5 text-sm text-slate-500">
            <p className="text-[11px] uppercase tracking-[0.4em] text-slate-400">Available Units Counter</p>
            <p className="mt-2 text-3xl font-display text-deepSlate">12 Signature Residences</p>
            <p className="text-sm">Open for curated buyers with soft closing window in Q3.</p>
          </div>
        </motion.div>
        ...
        >
          <p className="text-xs uppercase tracking-[0.4em] text-slate-400">Lead Form</p>
          <h2 className="mt-2 text-3xl font-display text-deepSlate">Submit Your Asset</h2>
          <p className="text-sm text-slate-500">
            One form unlocks valuation, marketing strategy, and direct introductions to vetted buyers.
          </p>
          ...
          <button
            type="submit"
            className="mt-6 w-full rounded-2xl bg-terracotta px-5 py-3 text-xs font-semibold uppercase tracking-[0.4em] text-stone transition hover:bg-black"
          >
